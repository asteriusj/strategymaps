...
/**
 * Test for /strategymaps
 */
Test('/strategymaps', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test strategymaps_get get operation', function (t) {
            Mockgen().requests({
                path: '/strategymaps',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/strategymaps']['get']['responses']['200']['schema']);
         ...
         * responses: 405
         */
        t.test('test addStrategyMap post operation', function (t) {
            Mockgen().requests({
                path: '/strategymaps',
                operation: 'post'
            }, function (err, mock) {
