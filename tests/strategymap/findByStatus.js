...
/**
 * Test for /strategymap/findByStatus
 */
Test('/strategymap/findByStatus', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200, 400
         */
        t.test('test findStrategyMapByStatus get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/strategymap/findByStatus']['get']['responses']['200']['schema']);
