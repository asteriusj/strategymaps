...
/**
 * Test for /strategymap
 */
Test('/strategymap', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test strategymap_get get operation', function (t) {
            Mockgen().requests({
                path: '/strategymap',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/strategymap']['get']['responses']['200']['schema']);
