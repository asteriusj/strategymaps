...
/**
 * Test for /strategymaps/findByStatus
 */
Test('/strategymaps/findByStatus', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200, 400
         */
        t.test('test findStrategyMapsByStatus get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/strategymaps/findByStatus']['get']['responses']['200']['schema']);
