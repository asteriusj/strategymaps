...
Test('/map/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getMapById get operation', function (t) {
            Mockgen().requests({
                path: '/map/{id}',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/map/{id}']['get']['responses']['200']['schema']);
         ...
         * responses: 405
         */
        t.test('test updateMapWithForm post operation', function (t) {
            Mockgen().requests({
                path: '/map/{id}',
                operation: 'post'
            }, function (err, mock) {
         ...
         * responses: 400, 404
         */
        t.test('test deleteMap delete operation', function (t) {
            Mockgen().requests({
                path: '/map/{id}',
                operation: 'delete'
            }, function (err, mock) {
