...
/**
 * Test for /strategymaps/{id}
 */
Test('/strategymaps/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getStrategyMapById get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/strategymaps/{id}']['get']['responses']['200']['schema']);
         ...
         * responses: 405
         */
        t.test('test updateStrategyMapWithForm post operation', function (t) {
            Mockgen().requests({
                path: '/strategymaps/{id}',
                operation: 'post'
            }, function (err, mock) {
         ...
         * responses: 400, 404
         */
        t.test('test deleteStrategyMap delete operation', function (t) {
            Mockgen().requests({
                path: '/strategymaps/{id}',
                operation: 'delete'
            }, function (err, mock) {
